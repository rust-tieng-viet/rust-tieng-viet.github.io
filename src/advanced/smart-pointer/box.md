...
![Diagram showing infinite size problem with recursive Cons List type in Rust](./box-cons.svg)
...
![Diagram showing how Box<T> solves the recursive type size problem with fixed-size pointers](./box-cons-box.png)
